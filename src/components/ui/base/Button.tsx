...
type ButtonVariant = "primary" | "outline" | "ghost" | "softOrange";
...
const Button = ({
    ...
    const baseStyles =
        "inline-flex items-center justify-center gap-2 rounded-xl transition cursor-pointer disabled:cursor-not-allowed disabled:opacity-50";
